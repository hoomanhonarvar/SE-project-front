...
const Aboutus=()=>{
    return(
      <div className="row" style={{direction:'rtl' ,backgroundColor:'white'}}>
        ...
        <p>
          فروشگاه Bshoot عرضه کننده انواع دسته بندی محصولات است .
          شما از طریق این فروشگاه میتواند محصولات ارائه دهنده را مشاهده و تهیه نمایید.
          فروشگاه Bshoot در صفحات محصول خود توضیحات جامعی درباره محصولات خود در اختیار شما قرار میدهد
          ...
          و خریداری نمایید.
          <br />
          فرشگاه Bshoot  از ارسال پستی به عرضه  انواع محصولات ارائه دهنده  میپردازد و از اینکه در این 
